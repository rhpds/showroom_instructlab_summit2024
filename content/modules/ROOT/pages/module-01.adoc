...
WARNING: Several steps in this section involving installation and configuration of InstructLab were completed for you. The title "Reference" will appear above code blocks that have been completed and will ERROR if executed. These steps are included for reference only.
...
*Step 1*: The `ilab model download` command is used to pull models from the source.
